...
import './logo.css'
const Homepage = () => {
  const backgroundImageUrl = 'url("https://media1.thehungryjpeg.com/thumbs2/ori_68614_3c160ec3d92ca68ed33d530ac32d0b3898dd0588_purple-blue-flowered-background-papers.jpg")';
  ...
  return (
    ...
    <div>
      ...
      <div style={styles}>
        ...
        <Button onClick={handle5}variant="outlined" style={{color:'black',borderColor:'black'}} ><h4>Donation</h4></Button>
        <br></br>
      </div>
